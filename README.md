...
<img width="1311" height="325" alt="image" src="https://github.com/user-attachments/assets/c1248fb8-1835-41f3-bcbd-68e3623b3fa7" />

The system retrieves relevant information at query time and provides the required context to the language model rather than requiring the entire organizational knowledge base to be incorporated into the model.Knowledge Sources
